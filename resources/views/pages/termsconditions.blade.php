...
@section('content')
    <div class="container py-5">
        <div >
            ...
            <h3 class="text-justify">Welcome to {{ config('app.name')}}!</h3> <br>
            <p>These terms and conditions outline the rules and regulations for the use of {{ config('app.name')}} Website, located at {{ config('app.name')}}.site</p>
            
            <p>By accessing this website we assume you accept these terms and conditions. Do not continue to use {{ config('app.name')}} if you do not agree to take all of the terms and conditions stated on this page.</p>
            ...
            <h5>Hyperlinking to our Content</h5><br>
